...
public class ShapeFactoryTestSuite
{
    ...
    void testFactoryCircle()
    {
        ...
        //Then
        Assertions.assertEquals(Math.PI * Math.pow(4.5, 2), circle.getArea(),0);
    ...
    void testFactorySquare()
    {
        ...
        //Then
        Assertions.assertEquals(28, square.getCircumference(),0);
    ...
    void testFactoryRectangle()
    {
        ...
        //Then
        Assertions.assertEquals(37.5, rectangle.getArea(),0);
